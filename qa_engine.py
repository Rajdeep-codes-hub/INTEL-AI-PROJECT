...
# def handle_query_or_image(query, image, detect_apparatus_mode=False):
...
#     ],
#     outputs=[
#         gr.Textbox(label="TinyLlama's Answer / Apparatus Detection"),
#         gr.Image(type="pil", label="Detection Result Image")
#     ],
#     title="📘 CBSE QA + Apparatus Detection (TinyLlama, Supabase Logging)",
#     description="Ask questions, upload textbook images, or detect apparatus in lab images. All queries and answers are logged to Supabase.",
